...
setup(
  ...
  download_url = 'https://github.com/lappsgrid-incubator/python-api/archive/0.1.tar.gz', # I'll explain this in a second
  keywords = ['lapps', 'nlp', 'web services'], # arbitrary keywords
